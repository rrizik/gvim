...
" General colors
hi Cursor               ctermfg=234  ctermbg=180  cterm=none     guifg=#1c1c1c      guibg=#d7af87   gui=none
...
" tab colors
hi TabLineSel           ctermfg=180  ctermbg=0    cterm=none     guifg=#d7af87	    guibg=#1c1c1c   gui=none
hi TabLine              ctermfg=180  ctermbg=0    cterm=none     guifg=#d7af87	    guibg=#444444   gui=none
hi TabLineFill          ctermfg=180  ctermbg=0    cterm=none     guifg=#d7af87	    guibg=#444444   gui=none
hi Title                ctermfg=180  ctermbg=0    cterm=none     guifg=#d7af87	    guibg=#1c1c1c   gui=none
...
hi Visual               ctermfg=7       ctermbg=238      cterm=none		 guifg=#1c1c1c		guibg=#d7af87   gui=none
"hi Visual               ctermfg=7       ctermbg=238      cterm=none		 guifg=#d7af87		guibg=#444444   gui=none

" Vim >= 7.0 specific colors
if version >= 700
hi CursorLine           ctermfg=7  ctermbg=180  cterm=none		 guifg=#d7af87  guibg=#444444  gui=none
hi MatchParen			ctermfg=7  ctermbg=243  cterm=none		 guifg=#1c1c1c  guibg=#949494  gui=none
hi Search				ctermfg=7  ctermbg=243  cterm=none		 guifg=#1c1c1c  guibg=#d7af87  gui=none
hi IncSearch			ctermfg=7  ctermbg=243  cterm=none		 guifg=#1c1c1c  guibg=#d7af87  gui=none
...
hi Red                  ctermfg=124      cterm=none		 guifg=#af0000	 guibg=#1c1c1c gui=underline,none
hi Yellow               ctermfg=184      cterm=none		 guifg=#d7d700	 guibg=#1c1c1c gui=underline,none
hi Green                ctermfg=107      cterm=none		 guifg=#87af5f	 guibg=#1c1c1c gui=underline,none
